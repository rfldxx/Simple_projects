...
#### 2C. Реструктуризация компании

Изначально каждый человек работает в своём собственном отделе, пронумерованном от $1$ до $n$. Обозначим за $team(\text{person})$ команду, в которой работает человек $\text{person}$. \
